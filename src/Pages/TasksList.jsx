  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#f8fafc", minHeight: "100vh" }}>
      <style>{`
        ...
        .tk-btn-add-nav:hover { background: #4596ab; }
        ...
        .tk-stat-pending .tk-stat-val { color: #F59E0B; }
        ...
        .tk-list-title { font-family: 'Outfit', sans-serif; font-size: 1.25rem; font-weight: 700; color: #0F172A; letter-spacing: -0.3px; }
        .tk-badge { background: #ebf4fa; color: #316398; font-size: 12px; font-weight: 600; padding: 3px 10px; border-radius: 100px; }
        ...
        .tk-card-location { font-family: 'Outfit', sans-serif; font-size: 1rem; font-weight: 700; color: #0F172A; letter-spacing: -0.3px; }
        .tk-status-pill {
          font-size: 11px; font-weight: 600; padding: 3px 10px; border-radius: 100px;
          white-space: nowrap; flex-shrink: 0;
        }
        .tk-status-pending { background: #ebf4fa; color: #316398; }
        ...
        .tk-btn-complete:hover { background: #4596ab; }
        .tk-btn-delete {
        ...
        .tk-textarea:focus, .tk-modal-input:focus { border-color: #4596ab; background: #fff; }
      ...
      <div className="tk-page fade-in">
        <div className="tk-header">
          ...
          <button className="tk-btn-add-nav" onClick={() => navigate("/tasks")}>
            ...
            <div key={task._id} className={`tk-card${task.status === "completed" ? " completed" : ""}`}>
              ...
              <div className="tk-card-body">
                ...
                <div className="tk-card-row">
                  ...
                  Scheduled Date:&nbsp;<strong>{task.date ? new Date(task.date).toLocaleDateString("en-IN", { day: "numeric", month: "short", year: "numeric" }) : "—"}</strong>
                </div>
                <div className="tk-card-row">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
              ...
              <div className="tk-card-footer">
                {task.status === "pending" && (
                  <button
                    ...
                    onClick={() => updateStatus(task._id, "waiting")}
                  >
                    <svg
                      width="13"
                      height="13"
          ...
          <div className="tk-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="tk-modal-body">
              <textarea
                ...
                placeholder="Services Done (comma separated)"
              ...
              <textarea
                className="tk-textarea"
                placeholder="Complaints (comma separated)"
